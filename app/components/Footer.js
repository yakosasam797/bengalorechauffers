        ...
        <footer className={styles.footer}>
            <div className={`container ${styles.grid}`}>
                ...
                <div className={styles.col}>
                    ...
                    <ul className={styles.colLinks}>
                        <li><a href="mailto:book@bangalorechauffeur.com">book@bangalorechauffeur.com</a></li>
                        <li><a href="tel:+919164544555">+91 9164544555</a></li>
                        <li><span>Bangalore — 560068</span></li>
                    </ul>
                </div>
            </div>
            ...
            <div className={styles.bottom}>
                <div className="container">
                    <p>© {new Date().getFullYear()} Bengaluru Chauffeurs. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
